...
function shell(body, { portal = false } = {}) {
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <meta property="og:url" content="https://verify.misfitmafia.site/">
  ...
  <link rel="canonical" href="https://verify.misfitmafia.site/">
...
app.get('/portal', (_req, res) => {
  res.status(200).send(shell(`
    <section class="portal-title"><h1>Misfit Mafia YouTube Bot</h1><p>Verification Portal</p></section>
